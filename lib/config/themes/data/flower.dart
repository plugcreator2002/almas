...
class FlowerTheme extends ThemeConfig {
  @override
  String get name => ThemesConst.flower;
  ...
  @override
  Color get info => MineColors.flowersPrimary;

  @override
  Color get inherit => MineColors.lightInherit;

  @override
  Color get primary => MineColors.flowersPrimary;
