...
class LonelyBoyTheme extends ThemeConfig {
  @override
  String get name => ThemesConst.lonelyboy;
  ...
  @override
  Color get info => MineColors.nightPrimary;

  @override
  Color get inherit => MineColors.darkInherit;

  @override
  Color get primary => MineColors.nightPrimary;
