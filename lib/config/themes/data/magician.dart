...
class MagicianTheme extends ThemeConfig {
  @override
  String get name => ThemesConst.magician;
  ...
  @override
  Color get info => MineColors.paintPrimary;

  @override
  Color get inherit => MineColors.lightInherit;

  @override
  Color get primary => MineColors.paintPrimary;
