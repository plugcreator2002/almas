...
class DarkCoastTheme extends ThemeConfig {
  @override
  String get name => ThemesConst.darkcoast;
  ...
  @override
  Color get info => MineColors.cr7Primary;

  @override
  Color get inherit => MineColors.lightInherit;

  @override
  Color get primary => MineColors.cr7Primary;
