...
class LightTheme extends ThemeConfig {
  @override
  String get name => ThemesConst.light;

  @override
  String get imageGemEmpty => MineImages.gemEmpty;

  @override
  String get imageGem => MineImages.gemBlue;
  ...
  @override
  Color get info => MineColors.lightInfo;

  @override
  Color get inherit => MineColors.lightInherit;

  @override
  Color get primary => MineColors.lightPrimary;
