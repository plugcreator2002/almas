...
class DarkPlainTheme extends ThemeConfig {
  @override
  String get name => ThemesConst.darkplain;
  ...
  @override
  Color get info => MineColors.mountainPrimary;

  @override
  Color get inherit => MineColors.darkInherit;

  @override
  Color get primary => MineColors.mountainPrimary;
