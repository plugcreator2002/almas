...
class Back1Theme extends ThemeConfig {
  @override
  String get name => ThemesConst.back1;
  ...
  @override
  Color get info => MineColors.cosmosPrimary;

  @override
  Color get inherit => MineColors.lightInherit;

  @override
  Color get primary => MineColors.cosmosPrimary;
