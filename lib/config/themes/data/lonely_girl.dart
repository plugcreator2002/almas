...
class LonelyGirlTheme extends ThemeConfig {
  @override
  String get name => ThemesConst.lonelygirl;
  ...
  @override
  Color get info => MineColors.skyPrimary;

  @override
  Color get inherit => MineColors.darkInherit;

  @override
  Color get primary => MineColors.skyPrimary;
